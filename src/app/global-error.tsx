...
export default function GlobalError({
  ...
  useEffect(() => {
    ...
    console.error("[cultiOS] [global-error] Exception:", msg, "Digest:", digest);
    if (stack) console.error("[cultiOS] [global-error] stack:", stack);
    if (error?.cause) console.error("[cultiOS] [global-error] cause:", error.cause);
  }, [error]);
    ...
    <html lang="es">
      <body style={{ fontFamily: "system-ui, sans-serif", padding: "2rem", textAlign: "center" }}>
        ...
        <p style={{ color: "#666", fontSize: "0.875rem", marginBottom: "1rem" }}>
          Revisá los logs del servidor (Vercel → Logs). Buscá <strong>[cultiOS]</strong> o el digest.
        </p>
