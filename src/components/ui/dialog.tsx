...
import { useTenantThemePortal } from "@/components/theme-context";
...
const DialogFooter = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
  <div
    className={cn(
      "flex flex-col-reverse sm:flex-row sm:justify-end sm:gap-2 pt-4 mt-4 border-t border-border",
      className
    )}
    {...props}
  />
