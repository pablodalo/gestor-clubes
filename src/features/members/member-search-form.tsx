...
export function MemberSearchForm({ tenantSlug, initialQ = "", initialStatus = "" }: Props) {
    ...
    <form onSubmit={handleSubmit} className="flex flex-wrap items-end gap-4">
      <div className="space-y-2">
        ...
        <Input
          ...
          placeholder="Nombre, nº socio, email, documento..."
          className="w-64"
        />
      </div>
      <div className="space-y-2">
        ...
        <select
          id="status"
          name="status"
          className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm w-40"
